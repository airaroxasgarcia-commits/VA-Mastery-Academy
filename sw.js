// VA Mastery Academy — service worker
...
const CACHE_VERSION = 'va-academy-v1';
const APP_SHELL = [
  './index.html',
  './manifest.json',
  './icon-192.png',
...
// network-first freshness check for index.html so updates roll out
// without needing a full uninstall/reinstall.
